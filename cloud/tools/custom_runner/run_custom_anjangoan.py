...
CUSTOM_FETCHER_SCRIPT = Path(__file__).resolve().parent / "custom_fetch_anjangoan.py"
...
# ------------------------------------------------------------------
SITE_ID = "Sawda"   # edit this site name for the illios_power tree Bamkhal, Anjangoan, Nandgaon, Gugariyakhedi, Balakwada, Andad, Sawda
CUSTOM_DATE = "2026-07-09"  # YYYY-MM-DD
CUSTOM_START_BLOCKS = [28]  # one or more start blocks (1..96)
