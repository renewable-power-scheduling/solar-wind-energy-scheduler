        ...
        <table className="w-full">
          <thead>
            <tr className="bg-muted/50">
              <th className="px-4 py-3 text-left text-xs font-semibold text-white dark:text-white uppercase tracking-wider w-24">
                Time
              </th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-white dark:text-white uppercase tracking-wider">
                Forecast (MW)
              </th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-white dark:text-white uppercase tracking-wider">
                Actual (MW)
